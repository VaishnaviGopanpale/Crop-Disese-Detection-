...
def main():
    st.set_page_config(page_title="AgriSens - Fertilizer Prediction", page_icon=":farm:", layout="wide")
    ...
    st.sidebar.header('AgriSens')

    # Taking direct inputs for parameters (no step for sliders)
    temp = st.sidebar.number_input("Temperature (in Celsius)", min_value=-30, max_value=50, value=25)
